/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: b257f200f6172608db8cdcb3769ea876)
// Runtime types generated with workerd@1.20250726.0 2024-12-30 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXTJS_ENV: string;
		BACKEND_URL: string;
		WORKER_SELF_REFERENCE: Fetcher /* twilio-realtime-frontend */;
		ASSETS: Fetcher;
	}
}
